...
# Optional and manual adds
# choco install -y lili # LinuxLive USB Creator
# choco install -y llvm
# choco install -y video-repair-software
# choco install -y recuva
# choco install -add olive-tree
# choco install -add disk-savvy
# choco install -add show-key-plus
# choco install -add thinkorswim
# choco install -add handbrake
# choco install -add flashback-express
